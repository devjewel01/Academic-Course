//write a program to get the movie name, the price of an adult ticket price, the price of a child ticket price, the number of adult tickets sold, and the number of child tickets sold.
